...
The power coupling for the module uses a standard 16 pin (2x08) IDC connector as detailed in the original [A-100 Doepfer power system bus](https://doepfer.de/a100_man/a100t_e.htm).
...
| J1,J3,J4,J5,J6,J13,J14 | 7   | 3.5mm Jack, vertical             | Same Sky        | SJ3-35052B     | https://mou.sr/4pc158c |
| J2                     | 1   | 16 pos 2x08 IDC pins (male)      | Samtec          | TST-108-02-T-D | https://mou.sr/4oMjFmU |
| J7,J12                 | 2   | 1x20 socket connector (optional) | Samtec          | SLW-120-01-G-S | https://mou.sr/3QWWbzf |
| J9                     | 1   | 1x06 socket connector            | Samtec          | SSW-106-01-T-S | https://mou.sr/4ahPiPr |
| J10                    | 1   | MIDI jack                        | Switchcraft     | 57GB5FX        | https://lovemyswitches.com/switchcraft-midi-jack-connector-57gb5fx-panel-mount/ |
...
| --                     | 1   | 5 way tactile switch             | (various)       | --             | https://github.com/sparkfun/5-Way_Tactile_Switch_Breakout |
| --                     | 1   | 0.96" SSD1306-based I2C OLED     | (various)       | --             | https://www.pcboard.ca/oled-128x64 |

## Assembly Components
| ID | Qty | Description               |                        |
|----|-----|---------------------------|------------------------|
| -- | 5   | 13mm PCB Standoff 3M hole |                        |
| -- | 2   | M2 nut                    |                        |
| -- | 2   | M2 x 8mm screw            |                        |
| -- | 6   | M3 nut                    |                        |
| -- | 8   | M3 x 2mm spacer           | (3d printed or bought) |
| -- | 10  | M3 x 5mm screw            |                        |
| -- | 6   | M3 x 8mm screw            |                        |
